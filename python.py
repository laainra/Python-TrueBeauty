...
#MONAAA
        ...
        billarea_Frame.place(x=1190, y=188, width=330, height=372)
        ...
        print_button = Button(button_frame, text="Cetak", font=("Arial Black", 15), pady=10, bg="#E5B4F3", fg="#6C3483", width=8, command=on_print_button_click)
...
def on_print_button_click():
    result = messagebox.askyesno("Cetak", "Apakah Anda yakin ingin mencetak teks?")
    if result:
        clear()
